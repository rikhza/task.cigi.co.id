                           ...
                           <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="">
                                  ...
                                  <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('workspace_name') is-invalid @enderror" name="workspace" id="workspace_name" value="{{ old('workspace') }}" required autocomplete="workspace"  placeholder="{{ __('Enter Your Workspace Name') }}">
                                       @error('company')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
