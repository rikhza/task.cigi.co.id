    ...
    @auth('web')
        ...
        @if($currentWorkspace->creater->id == Auth::user()->id)
                ...
                <i class="ti ti-edit"></i>
                  ...
                  <a href="#" class="btn btn-sm  mx-1 btn-primary cp_link " data-link="{{route('pay.invoice',[$currentWorkspace->slug,\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)])}}" data-toggle="tooltip" data-bs-toggle="tooltip" data-bs-original-title="{{__('Copy')}}" data-original-title="{{__('Click to copy invoice link')}}"><span class="btn-inner--icon text-white"></span><span class="btn-inner--text text-white"><i class="ti ti-copy"></i></span></a>
