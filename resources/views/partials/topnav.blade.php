         ...
         @endif
          ...
          <li class="dropdown dash-h-item drp-company">
              <a
                ...
                aria-expanded="false"
              >
                 <img class="theme-avtar"@if(Auth::user()->avatar) src="{{asset('/storage/avatars/'.Auth::user()->avatar)}}" @else avatar="{{ Auth::user()->name }}" @endif alt="{{ Auth::user()->name }}">
              ...
              <div class="dropdown-menu dash-h-dropdown">
                ...
                <a href="#" class="dropdown-item" title="{{__('Locked')}}">
                 ...
                 @if(isset($workspace->pivot->permission))
                    @if($workspace->pivot->permission =='Owner')
                        <span class="badge badge-success-primary">{{__($workspace->pivot->permission)}}</span>
                    @else
                        <span class="badge bg-dark">{{__('Shared')}}</span>
                    @endif
                  @endif
              ...
              @if(isset($currentWorkspace) && $currentWorkspace)
               @auth('web')
                @if(Auth::user()->id == $currentWorkspace->created_by )
                   <a href="#" class="dropdown-item bs-pass-para" data-confirm="{{__('Are You Sure?')}}" data-text="{{__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="remove-workspace-form">
