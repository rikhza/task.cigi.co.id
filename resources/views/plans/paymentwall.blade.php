  ...
  <head>
    ...
    {{-- <title>@if(Auth::user()->type == 'admin')  {{config('app.name', 'Taskly SaaS')}} @else {{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Taskly SaaS')}} @endif</title> --}}
